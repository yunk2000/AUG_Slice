...
def main():
    ...
    for node in all_func_node:
        ...
        d_use, d_def = getUseDefVarByPDG(j, opt_pdg_1)
        
        opt_pdg_2 = modifyDataEdgeVal(opt_pdg_1)
        
        opt_pdg_3 = completeDeclStmtOfPDG(opt_pdg_2, d_use, d_def, dict_if2cfgnode, dict_cfgnode2if)

        opt_pdg_4 = completeDataEdgeOfPDG(opt_pdg_3, d_use, d_def, dict_if2cfgnode, dict_cfgnode2if)
