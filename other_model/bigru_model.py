...
def train(corpus_path, labels_path, bgru_model_path, result_path):
    ...
    model = Sequential()
    model.add(Bidirectional(GRU(128), input_shape=(maxlen, max_features)))
...
def main():
    ...
    bgru_model_path = "./data/model/bigru_model_30"
    result_path = './data/result/bigru_result.txt'
    train(train_corpus_path, labels_path, bgru_model_path, result_path)
